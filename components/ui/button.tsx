...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold tracking-tight transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_18px_50px_-24px_hsl(var(--primary))] hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-[0_24px_70px_-24px_hsl(var(--primary))]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-border/70 bg-background/55 shadow-sm backdrop-blur-xl hover:-translate-y-0.5 hover:border-primary/60 hover:bg-primary/10 hover:text-foreground",
        secondary:
